...
mainPath = 'C:/Users/Jhony/Desktop/ResultadosOptimistasYnoOptimistas/optimistas/Experiment2/LASSO/';
networksNames = {'GoogLeNet', 'MixtureNet', 'MixtureResNet', 'ResNet50', 'ResNet101', 'ResNet152'};
load([savePath 'i.mat']);
load([savePath 'j.mat']);
inicioI = i;
inicioJ = j;
for(i=inicioI:size(networksNames,2))
    ...
    for(j=inicioJ:size(classifiersFolder,1)-2)
       ...
       main
       clear all;
       load(['C:/Users/Jhony/Desktop/ResultadosOptimistasYnoOptimistas/optimistas/Experiment2/LASSO/savesAllExperimentsExcecution/workspace.mat']);
       cd(mainPath);
    end
    inicioJ = 1;
    save([savePath 'j.mat'],'j');
