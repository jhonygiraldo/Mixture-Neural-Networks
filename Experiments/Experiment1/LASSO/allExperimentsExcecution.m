...
mainPath = 'C:/Users/Jhony/Desktop/ResultadosOptimistasYnoOptimistas/optimistas/Experiment1/LASSO/';
...
for(i=inicioI:size(networksNames,2))
    ...
    for(j=inicioJ:size(classifiersFolder,1)-2)
       ...
       main
       clear all;
       load(['C:/Users/Jhony/Desktop/ResultadosOptimistasYnoOptimistas/optimistas/Experiment1/LASSO/savesAllExperimentsExcecution/workspace.mat']);
       cd(mainPath);
    end
    inicioJ = 1;
    save([savePath 'j.mat'],'j');
